...
if (isset($_POST['submit']) && count($errorsArray) == 0) {
    ...
    $patientsObj->birthDate = $dateEN;
    $patientsObj->lastName = $lastName;
    $patientsObj->firstName = $firstName;
    $patientsObj->phone = $phone;
    $patientsObj->mail = $mail;
    //j'éxécute la méthode create patients avec les attributs précedement stockés
    $patientsObj->CreatePatients();
    $addsuccess=true;
